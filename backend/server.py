...
# ==================== MALİ BELLEK YÖNETİMİ ====================

class MaliBellekToggle(BaseModel):
    admin_id: str
    admin_name: str

@api_router.get("/companies/{company_id}/mali-bellek")
...
@api_router.post("/mali-bellek/{product_id}/toggle")
...
@api_router.get("/mali-bellek/{product_id}/logs")
