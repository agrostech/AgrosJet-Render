    ...
    <div data-testid="courier-akademi-page" className="space-y-4">
      ...
      <div className="border-2 border-border bg-white p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-heading font-bold text-lg md:text-xl">Akademi</h2>
      ...
      <div className="border-2 border-border bg-white p-6 md:p-12">
        <div className="text-center max-w-md mx-auto">
          <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-slate-100 flex items-center justify-center mx-auto mb-4 md:mb-6">
            <GraduationCap className="w-8 h-8 md:w-10 md:h-10 text-slate-600" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 text-left">
            <div className="p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
              <Video className="w-5 h-5 md:w-6 md:h-6 text-slate-600 mb-2" />
            ...
            <div className="p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
              <BookOpen className="w-5 h-5 md:w-6 md:h-6 text-slate-600 mb-2" />
            ...
            <div className="p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
              <FileText className="w-5 h-5 md:w-6 md:h-6 text-slate-600 mb-2" />
            ...
            <div className="p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
              <Award className="w-5 h-5 md:w-6 md:h-6 text-slate-600 mb-2" />
