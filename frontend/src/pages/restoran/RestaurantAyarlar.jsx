...
import { Printer, Settings, TestTube, CheckCircle2, XCircle, RefreshCw, Download, ChevronDown } from "lucide-react";
...
export default function RestaurantAyarlar({ restaurantId, restaurantName }) {
  ...
  const updateLocalSetting = (key, value) => {
    ...
    saveLocalPrintSettings(restaurantId, newSettings);
  };
          ...
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 cursor-pointer hover:bg-slate-50">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Yazdırma</span>
                {serverStatus.connected ? (
