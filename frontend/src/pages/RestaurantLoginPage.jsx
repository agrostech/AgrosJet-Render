...
export default function RestaurantLoginPage() {
  ...
  const loginImage = "https://customer-assets.emergentagent.com/job_dfe6f827-18c8-44fa-9707-d7a9c2d6e4a6/artifacts/x97yidci_agrosjetapplogin%20%281%29.png";
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      if (user.role === "restaurant") navigate("/restoran");
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${API}/restaurant-users/login`, formData);
      const sessionData = {
        ...res.data,
        rememberMe,
