            ...
            <form onSubmit={handleEditCourier} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input data-testid="edit-courier-name" value={editData.name} onChange={(e) => setEditData({ ...editData, name: e.target.value })} className="mt-1 h-10 border-2" />
                </div>
                <div>
                  <Label className="text-sm font-semibold">Telefon</Label>
                  <Input data-testid="edit-courier-phone" value={editData.phone} onChange={(e) => setEditData({ ...editData, phone: e.target.value })} className="mt-1 h-10 border-2 font-mono" />
                </div>
              </div>
              
              <div>
                <Label className="text-sm font-semibold">Plaka</Label>
                <Input data-testid="edit-courier-plate" value={editData.plate} onChange={(e) => setEditData({ ...editData, plate: e.target.value })} className="mt-1 h-10 border-2 font-mono uppercase" />
              </div>
              
              <div>
                <Label className="text-sm font-semibold">Adres</Label>
                <Input data-testid="edit-courier-address" value={editData.address} onChange={(e) => setEditData({ ...editData, address: e.target.value })} className="mt-1 h-10 border-2" />
              </div>
              
              <div>
                <Label className="text-sm font-semibold">Yeni Şifre</Label>
                <Input data-testid="edit-courier-password" type="password" value={editData.password} onChange={(e) => setEditData({ ...editData, password: e.target.value })} className="mt-1 h-10 border-2" placeholder="Değiştirmek istemiyorsanız boş bırakın" />
              </div>
              ...
              <Button type="submit" className="w-full h-11 font-semibold" disabled={editLoading} data-testid="submit-edit-courier">
