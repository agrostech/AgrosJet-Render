      ...
      <Card>
        <CardContent className="p-3 space-y-3">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
            ...
            <div>
              ...
              <Select value={sourceFilter} onValueChange={setSourceFilter}>
                <SelectTrigger className="h-8 text-xs" data-testid="source-filter"><SelectValue placeholder="Tümü" /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">Tümü</SelectItem>
          ...
          <div className="flex gap-2">
            <Button onClick={handleFilter} disabled={loading} size="sm" className="h-8 flex-1 sm:flex-none sm:w-auto px-4 text-xs gap-1.5" data-testid="filter-orders-btn">
