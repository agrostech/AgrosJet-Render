        ...
        <Card>
          <CardHeader className="pb-2 px-3 sm:px-6">
            ...
            <div className="sm:hidden -mx-3 -mt-6 mb-2 px-3 pt-3 pb-2 bg-slate-50 dark:bg-slate-800/50 rounded-t-lg space-y-2">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Select value={sortOrder} onValueChange={setSortOrder}>
                  <SelectTrigger className="h-8 w-8 px-0 justify-center rounded-lg border-slate-200" data-testid="order-sort-btn">
          ...
          <CardContent className="px-2 sm:px-6">
            ...
            {paginatedOrders.length > 0 && totalPages > 1 && (
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 mt-4 pt-4 border-t" data-testid="pagination-controls">
                    ...
                    for (let i = startPage; i <= endPage; i++) {
                      pages.push(
                        <Button
                          ...
                          className={`h-7 w-7 text-xs p-0 ${i === currentPage ? "bg-primary text-white" : ""}`}
