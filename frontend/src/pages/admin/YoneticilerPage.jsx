          ...
          {selectedAdmin && (
            <form onSubmit={handleEditAdmin} className="space-y-4">
              ...
              <div>
                ...
                <Input data-testid="edit-admin-name" value={editData.name} onChange={(e) => setEditData({ ...editData, name: e.target.value })} className="mt-1 h-11 border-2" placeholder="Değiştirmek istemiyorsanız boş bırakın" />
              </div>
              
              <div>
                <Label className="text-sm font-semibold">Yeni Şifre</Label>
                <Input data-testid="edit-admin-password" type="password" value={editData.password} onChange={(e) => setEditData({ ...editData, password: e.target.value })} className="mt-1 h-11 border-2" placeholder="Değiştirmek istemiyorsanız boş bırakın" />
              </div>
              ...
              <Button type="submit" className="w-full h-11 font-semibold" disabled={editLoading} data-testid="submit-edit-admin">
