...
import { Menu, X, LogOut, Clock, Calculator, Package, Users, UserCog, LayoutDashboard, SlidersHorizontal, ShoppingBag, GraduationCap, User, MoreHorizontal, ChevronDown, Building2, Store, ClipboardList, FileText } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const allNavItems = [
    ...
    { path: "/admin/raporlar", label: "Raporlar", icon: FileText, key: "raporlar", permKey: "raporlar" },
