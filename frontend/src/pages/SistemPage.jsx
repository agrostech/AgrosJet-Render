...
export default function SistemPage({ companyId }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Google Entegrasyonu */}
      <div className="border-2 border-border bg-white">
        <div className="p-4 border-b-2 border-border bg-blue-50 flex items-center gap-2">
          <Cloud className="w-5 h-5 text-blue-600" />
          <h3 className="font-semibold text-blue-900">Google Entegrasyonu</h3>
        </div>
        
        {googleLoading ? (
          <div className="p-8 text-center text-muted-foreground">Yükleniyor...</div>
        ) : (
          <form onSubmit={handleGoogleSave} className="p-4 space-y-6">
            {/* Info Banner */}
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex gap-3">
                <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                <div className="text-sm text-blue-800">
                  <p className="font-medium mb-1">Google Cloud Console Kurulumu</p>
                  <ol className="list-decimal list-inside space-y-1 text-blue-700">
                    <li>
                      ...
                      </a>'a gidin ve proje oluşturun
                    </li>
                    <li>Gmail API ve Google Drive API'yi etkinleştirin</li>
                    <li>OAuth 2.0 istemci kimliği oluşturun (Web uygulaması)</li>
                    <li>Yetkilendirilmiş yönlendirme URI'si: <code className="bg-blue-100 px-1 rounded text-xs">{process.env.REACT_APP_BACKEND_URL}/api/google/oauth/callback</code></li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            {/* API Credentials */}
            <div className="space-y-4">
              <h4 className="font-medium text-sm text-slate-700">API Kimlik Bilgileri</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input 
                    ...
                    className="mt-1 h-11 border-2 font-mono text-sm"
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    <Input 
                      ...
                      className="h-11 border-2 font-mono text-sm pr-10"
                      placeholder={googleStatus.exists ? "Mevcut değeri değiştirmek için yeni girin" : "GOCSPX-xxxx"}
                    />
                    <button
                      type="button"
              ...
              <div>
                <Label className="text-sm font-semibold">Drive Klasör ID (İsteğe bağlı)</Label>
                <Input 
                  value={googleSettings.drive_folder_id}
                  onChange={(e) => setGoogleSettings({...googleSettings, drive_folder_id: e.target.value})}
                  className="mt-1 h-11 border-2 font-mono text-sm"
                  placeholder="Dosyaların yükleneceği Drive klasör ID'si"
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Boş bırakılırsa dosyalar Drive kök dizinine yüklenir
                </p>
              </div>
            </div>

            {/* Services Toggle & Connection */}
            <div className="space-y-4 pt-4 border-t border-border">
              <h4 className="font-medium text-sm text-slate-700">Servis Ayarları</h4>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Evrakları ve faturaları otomatik yükle</p>
                    </div>
                  </div>
                ...
                <div className="mt-4 flex items-center gap-2 flex-wrap">
                  {googleStatus.drive_connected ? (
                    <>
                      ...
                      >
                        {testingDrive ? "Test ediliyor..." : "Bağlantıyı Test Et"}
                      </Button>
                      <Button 
                        type="button" 
                        variant="ghost" 
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Bildirimleri e-posta ile gönder</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                ...
                <div className="mt-4 flex items-center gap-2 flex-wrap">
                  {googleStatus.gmail_connected ? (
                    <>
                      ...
                      >
                        {testingGmail ? "Test ediliyor..." : "Bağlantıyı Test Et"}
                      </Button>
                      <Button 
                        type="button" 
                        variant="ghost" 
            ...
            {/* Save Button */}
            <div className="pt-4 border-t border-border">
              <Button type="submit" disabled={googleSaving} className="h-11 font-semibold bg-blue-600 hover:bg-blue-700">
                <Save className="w-4 h-4 mr-2" />
                {googleSaving ? "Kaydediliyor..." : "Google Ayarlarını Kaydet"}
              </Button>
              <p className="text-xs text-muted-foreground mt-2">
                Önce ayarları kaydedin, ardından servislere bağlanabilirsiniz.
              </p>
            </div>
          </form>
        )}
