...
export default function IsletmelerTab({ companyId, adminId, adminName, companyLogo }) {
  ...
  const exportPDF = async () => {
    ...
    doc.save(`${selectedBusiness.name.replace(/[^a-zA-Z0-9ğüşıöçĞÜŞİÖÇ ]/g, '_')}_islem_gecmisi.pdf`);
