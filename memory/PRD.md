...
- 2026-02: **Kurye Detay Modalı → Bugünkü Vardiya badge'i** "Bugünkü Çalışma" satırına eklendi (emerald renk, Calendar ikonu). Mevcut `mergeConsecutiveShifts` ile ardışık vardiyalar tek aralığa birleşir (11:00-12:00 + 12:00-13:00 → 11:00-13:00); ardışık değilse virgülle ayrılır. Üst başlıktaki vardiya pill'i de korundu.
